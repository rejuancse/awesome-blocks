<?php
/**
 * Server-side rendering for Awesome Hero Video Block
 *
...
$unique_id = 'ab-hero-' . uniqid();

// Build CSS variables
$css_vars = sprintf(
    '--ab-button-hover-bg-color: %s; --ab-button-hover-text-color: %s;',
...
<div class="villa-hero-video" style="<?php echo esc_attr( $wrapper_style ); ?>" data-id="<?php echo esc_attr( $unique_id ); ?>">
    <style>
        #<?php echo esc_attr( $unique_id ); ?> { <?php echo $css_vars; ?> }
    </style>
