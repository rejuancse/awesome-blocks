...
use ZepBlocks\Woo_Category_List;
...
class WooCategoryListTest extends TestCase {
    ...
    public function test_woo_category_list_has_render_method() {
        $this->assertTrue( method_exists( 'ZepBlocks\Woo_Category_List', 'render' ), 'Woo_Category_List should have a render method' );
    }
    ...
    public function test_render_content_method_exists() {
        $this->assertTrue( method_exists( 'ZepBlocks\Woo_Category_List', 'render_content' ), 'Woo_Category_List should have a render_content method' );
    }
    ...
    public function test_woo_category_list_namespace() {
        $this->assertEquals( 'ZepBlocks\Woo_Category_List', Woo_Category_List::class );
    }
