...
* **Image Compare** – Let visitors interactively compare two images with a drag-to-reveal slider
* **Photo Gallery** – Create beautiful, responsive photo galleries with lightbox support
* **Post Block** – Display your latest posts or custom post types in a customizable grid or list layout
...
* **WooCommerce ready** – Built-in blocks for WooCommerce category and product display
* **Lightweight** – Only loads assets for blocks that are actually used on the page
* **Theme compatible** – Works with any WordPress theme, including Full Site Editing (FSE) themes
* **Regularly updated** – New blocks added frequently based on user feedback
* **100% Free** – No upsells, no pro version, no limitations
